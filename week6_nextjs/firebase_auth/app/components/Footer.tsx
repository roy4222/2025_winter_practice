...
/**
 * 頁面底部的Footer組件
 * 顯示網站版權信息、導航連結和社交媒體圖標
 * @returns {JSX.Element} 渲染的頁面底部Footer
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-lg font-semibold mb-4">Next Firebase</h3>
            <p className="text-gray-400 text-sm">
              打造現代化的網頁應用程式，結合 Next.js 的強大功能和 Firebase 的靈活後端服務。
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Next Firebase 示例. 保留所有權利。</p>
        </div>
      </div>
    </footer>
  );
