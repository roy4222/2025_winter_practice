          ...
          <form className="space-y-6" action="#" method="POST">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
                我同意 <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">服務條款</a> 和 <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">隱私政策</a>
              </label>
            </div>
